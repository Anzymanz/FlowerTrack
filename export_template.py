...
.history-detail{flex:1;overflow:auto;border:1px solid var(--border);border-radius:8px;padding:12px;background:var(--panel);min-width:0;overscroll-behavior:contain}
...
.range-slider input[type=range]::-webkit-slider-thumb{pointer-events:auto;position:relative;z-index:10;margin-top:-4px}
.range-slider input[type=range]::-moz-range-thumb{pointer-events:auto;position:relative;z-index:10;top:-2px}
...
input.search-box{padding:8px 10px;border-radius:10px;border:1px solid var(--border);background:var(--panel);color:var(--fg);width:170px;min-width:140px;max-width:170px}
